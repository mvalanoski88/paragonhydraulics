            ...
            <div class="p-0 p-md-5 m-0">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <p>Your success is our priority. We work closely with our clients to understand their challenges and provide customized hydraulic solutions that enhance efficiency, reduce downtime, and optimize performance.</p>
                    </div>
                </div>
            </div>
        </section>
        <!--<section id="team" class="justify-content-center py-5">
            <div class="m-0 p-0">
                <SectionHeader heading="Meet Our Team" :style="'dark'" />
                <div class="row d-flex justify-content-center mt-3">
                    <div class="col-auto">
                        <ContactCard
                            name="STEVE FERRAZZARA"
                            imageUrl="steve.jpg" />
                    </div>
                    <div class="col-auto">
                        <ContactCard

...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/services-n9UZOS2p.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(_attrs)} data-v-070b3067><div class="${ssrRenderClass({ "mobile-overlay": mobileNav.value })}" data-v-070b3067></div><nav class="${ssrRenderClass([{ "scrolled-nav": scrollPosition.value, "scrolled-nav-open": mobileNav.value }, "w-100"])}" data-v-070b3067><div class="row align-items-center justify-content-md-between" data-v-070b3067><div class="col-6 col-md-4" data-v-070b3067>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img id="mainLogo" width="290" height="130"${ssrRenderAttr("src", `${unref(config).paragonConsts.AWS_IMG_DIR}phlogo.webp`)} alt="Paragon Hydraulics Logo" data-v-070b3067${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                id: "mainLogo",
      ...
      _push(`</div>`);
      if (!mobile.value) {
        _push(`<div class="desktop d-flex col-6 col-md-8 p-0 justify-content-end" data-v-070b3067><ul class="p-0 pl-md-4 d-inline-flex" data-v-070b3067><!--[-->`);
        ssrRenderList(navlinks.value, (link) => {
          _push(`<li class="mb-4 mb-md-0" data-v-070b3067>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: link.link
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      if (mobile.value) {
        _push(`<div class="col-6 d-flex justify-content-end" data-v-070b3067>`);
      ...
      if (mobileNav.value) {
        _push(`<ul class="p-0 pl-md-4 dropdown-nav" data-v-070b3067><!--[-->`);
        ssrRenderList(navlinks.value, (link) => {
          _push(`<li class="mb-4 mb-lg-0" data-v-070b3067>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        if (_ctx.$route.name != "contactus") {
          _push(`<li data-v-1c703980="" class="mobile-menu-cta d-flex d-lg-none align-self-center mb-4 mb-md-0" data-v-070b3067><a href="tel:757-937-3773" data-v-070b3067>`);
          _push(ssrRenderComponent(unref(Icon), { icon: "tabler:phone-call" }, null, _parent));
          _push(`</a><a href="mailto:rfq@paragonhydraulics.com?subject=RFQ Request" data-v-070b3067>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-070b3067"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<footer${ssrRenderAttrs(mergeProps({
        ...
        class: "p-4"
      }, _attrs))} data-v-6f6ed69c><div class="w-100" data-v-6f6ed69c><div class="row d-flex flex-column flex-md-row justify-content-between m-0" data-v-6f6ed69c><div class="col-12 col-md-4" data-v-6f6ed69c><div class="row" data-v-6f6ed69c><div class="col-12 d-flex d-lg-block align-items-center justify-content-center justify-content-md-start" data-v-6f6ed69c>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", `${unref(config).paragonConsts.AWS_IMG_DIR}phlogo_black.webp`)} width="175" alt="Paragon Hydraulics Logo" data-v-6f6ed69c${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
      ...
      _push(`<img class="mx-0 mx-md-2"${ssrRenderAttr("src", `${unref(config).paragonConsts.AWS_IMG_DIR}vsralogo_bw.webp`)} width="110" alt="VSRA Logo" data-v-6f6ed69c></div></div></div><div class="col-12 col-md-5 col-lg-8 d-flex align-items-center justify-content-center justify-content-md-end p-0 m-0" data-v-6f6ed69c><div class="d-flex row footer-text text-uppercase" data-v-6f6ed69c><div class="d-flex p-0 justify-content-center justify-content-lg-end" data-v-6f6ed69c><span data-v-6f6ed69c>Iso 9001-2015 compliant</span></div><div class="d-flex p-0 justify-content-center justify-content-lg-end" data-v-6f6ed69c><span data-v-6f6ed69c><a class="text-decoration-none"${ssrRenderAttr("href", !unref(isDesktopOrTablet) ? "tel:757-973-3773" : null)} data-v-6f6ed69c>757-973-3773</a> | <a class="text-decoration-none" href="https://maps.app.goo.gl/HDFT6u3Lu4PESYWZA" data-v-6f6ed69c>711 falcon ave, chesapeake va, 23324</a></span></div><div class="row d-flex flex-column flex-md-row p-0 w-100 m-0" data-v-6f6ed69c><div class="d-flex p-0 justify-content-center justify-content-lg-end" data-v-6f6ed69c><span class="footer-credit" data-v-6f6ed69c>`);
      _push(ssrRenderComponent(unref(Icon), { icon: "ic:twotone-build-circle" }, null, _parent));
      _push(`Built &amp; Managed by <a href="https://oceanfrontcreative.com/?utm_source=ParagonHydraulics&amp;utm_medium=referral" target="_blank" data-v-6f6ed69c>Oceanfront Creative</a></span></div></div></div></div></div></div></footer>`);
    };
  }
};
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-6f6ed69c"]]);
const _sfc_main$2 = {
  __name: "app",
  __ssrInlineRender: true,
  setup(__props) {
    useHead({
      link: [
        {
          href: "https://s3.amazonaws.com/assets.paragonhydraulics.com/other/Bebas.ttf",
          rel: "preload",
          as: "font",
          type: "font/ttf",
          crossorigin: true
      ...
      script: [
        {
          async: true,
          src: "https://www.googletagmanager.com/gtag/js?id=G-SBLQH60YKN"
        },
        {
          children: "window.dataLayer = window.dataLayer || [];\nfunction gtag(){dataLayer.push(arguments);}\ngtag('js', new Date());\n\ngtag('config', 'G-SBLQH60YKN');"
        }
      ]
    });
    useSeoMeta({
      title: "Paragon Hydraulics",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-Gqm1CB9i.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-p62vU9A_.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-zgHRo6TD.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();

...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getLogoSrc = (logo) => {
      return isDesktopOrTablet ? `https://s3.amazonaws.com/assets.paragonhydraulics.com/img/${logo.name}.png` : `https://s3.amazonaws.com/assets.paragonhydraulics.com/img/${logo.name}.webp`;
    };
